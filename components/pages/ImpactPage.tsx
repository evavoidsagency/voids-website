...
> = {
  nl: {
    ...
    problemCloseCta: "Ontdek de voordelen voor bedrijven →",
  ...
  en: {
    ...
    problemCloseCta: "Discover the benefits for companies →",
          ...
          <div className="wrap g-collapse" style={{ display: "grid", gridTemplateColumns: "1.05fr .95fr", gap: 44, alignItems: "stretch", padding: "96px 32px" }}>
            <div style={{ display: "flex", flexDirection: "column", height: "100%" }}>
              ...
              >
                ...
                <Link href={p("/companies")} style={{ fontSize: 13, fontWeight: 500, color: "var(--voids-purple-100)", textDecoration: "underline", textUnderlineOffset: "3px" }}>
                  {c.problemCloseCta}
                </Link>
              </div>
            </div>
