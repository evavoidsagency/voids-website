...
> = {
  nl: {
    ...
    pricingIntro: "Wil je een vacature plaatsen? Neem contact op. Twee manieren om af te rekenen:",
  ...
  en: {
    ...
    pricingIntro: "Want to post a vacancy? Get in touch. Two ways to pay for it:",
