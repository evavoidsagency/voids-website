  ...
  nl: [
    {
      ...
      blocks: [
        ...
        {
          p: "Heb je vragen over dit privacybeleid of over hoe wij met je persoonsgegevens omgaan, neem dan contact met ons op via contact@voids.agency of via https://voids.agency.",
        },
    ...
    },
    {
      ...
      blocks: [
        ...
        { p: "Wil je gebruikmaken van een van deze rechten, neem dan contact met ons op via contact@voids.agency." },
  ...
  en: [
    {
      ...
      blocks: [
        ...
        {
          p: "If you have questions about this Privacy Policy or about how we handle your personal data, you can contact us at contact@voids.agency or via https://voids.agency.",
        },
    ...
    },
    {
      ...
      blocks: [
        ...
        { p: "If you would like to exercise any of these rights, you can contact us at contact@voids.agency." },
